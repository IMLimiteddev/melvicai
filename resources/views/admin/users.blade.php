                  ...
                  <div class="card-body"> 
                    <div class="table-responsive custom-scrollbar user-datatable theme-scrollbar">
                      <table class="display custom-scrollbar" id="basic-12">
                        ...
                        <tbody>
                          <tr>
                            <td> <img class="img-fluid table-avtar" src="/dash/assets/images/user/1.jpg" alt="">Tiger Nixon</td>
                            ...
                            <td> 
                              <ul class="action"> 
                                <li class="edit"> <a href="#"><i class="fa fa-pencil"></i></a></li>
                                <li class="delete"><a href="#"><i class="fa fa-trash"></i></a></li>
                              </ul>
                            </td>
                          </tr>
