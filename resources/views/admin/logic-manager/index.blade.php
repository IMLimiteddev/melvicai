<x-layouts::app :title="__('Users')">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header pb-0 card-no-border d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <h4>Verbs Created</h4>
                                <span>Manage Operators and Actions</span>

                                <button type="button" class="btn btn-primary btn-sm" id="addVerbBtn">
                                    <i class="fa fa-plus"></i> Add New Verb
                                 </button>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive custom-scrollbar user-datatable theme-scrollbar">
                                ...
                                <table class="display custom-scrollbar table align-middle" id="basic-12">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="createRow" class="d-none">
                                            ...
                                            <form action="{{route('admin.verb.store')}}" method="POST">
                                                ...
                                                <td>
                                                    <input name="verb" class="form-control form-control-sm"
                                                        required>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <input name="meaning" class="form-control form-control-sm">
                                        ...
                                        @forelse($verbs as $verb)
                                            <tr>
                                                ...
                                                <form action="{{ route('admin.verb.edit', $verb->id) }}"
                                                    method="POST">
                                                    ...
                                                    <td>
                                                        ...
                                                        <span class="view">
                                                            ...
                                                            @if ($verb->type == 'Operator')
                                                                <span class="badge bg-primary">
                                                                    {{ $verb->type }}
                                                                </span>
                                                            @elseif($verb->type == 'Action')
                                                    ...
                                                    <td>
                                                        ...
                                                        {{ optional($verb->user)->name ?? 'Unknown' }}

                                                    </td>

                                                    <td>

                                                        {{ optional($verb->created_at)->format('d M Y') ?? '--' }}
                                                    ...
                                                    <td>
                                                        ...
                                                        <button type="submit"
                                                            class="btn btn-success btn-sm saveBtn d-none">
                                                        ...
                                                        <button type="button"
                                                            class="btn btn-secondary btn-sm cancelBtn d-none">
                                                ...
                                                <form action="{{ route('admin.verb.destroy', $verb->id) }}"
                                                    ...
                                                    <button onclick="return confirm('Delete this verb?')"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('addVerbBtn').onclick = function() {
            ...
            document.querySelectorAll('.editBtn').forEach(function(btn) {
                ...
                btn.onclick = function() {
                    ...
                    document.querySelectorAll('tbody tr').forEach(function(r) {
                        ...
                        r.querySelectorAll('.view').forEach(v => v.classList.remove('d-none'));
                        r.querySelectorAll('.edit').forEach(v => v.classList.add('d-none'));

                        let e = r.querySelector('.editBtn');
                        let s = r.querySelector('.saveBtn');
                        let c = r.querySelector('.cancelBtn');
                    ...
                    row.querySelectorAll('.edit').forEach(v => v.classList.remove('d-none'));

                    row.querySelector('.editBtn').classList.add('d-none');
                    row.querySelector('.saveBtn').classList.remove('d-none');
                    row.querySelector('.cancelBtn').classList.remove('d-none');
            ...
            document.querySelectorAll('.cancelBtn').forEach(function(btn) {
                ...
                btn.onclick = function() {
                    ...
                    row.querySelectorAll('.view').forEach(v => v.classList.remove('d-none'));
                    row.querySelectorAll('.edit').forEach(v => v.classList.add('d-none'));

                    row.querySelector('.editBtn').classList.remove('d-none');
                    row.querySelector('.saveBtn').classList.add('d-none');
                    row.querySelector('.cancelBtn').classList.add('d-none');
