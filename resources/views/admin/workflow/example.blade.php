                                ...
                                <tbody>
                                    ...
                                    @foreach ($configs as $o)
                                        <tr
                                            ...
                                            <td style="padding:18px; vertical-align:middle;">
                                                <a href="{{ route('admin.configs.single', $o?->config_name) }}"
                                                    wire:navigate
                                            ...
                                            <td style="padding:18px; vertical-align:middle;">
                                                <a href="{{ $o->input_file_path }}" target="_blank"
                                            ...
                                            <td style="padding:18px; vertical-align:middle;">
                                                <a href="{{ Storage::url($o->output_file_path) }}" target="_blank"
                                            ...
                                            <td style="padding:18px; text-align:center; vertical-align:middle;">
                                                ...
                                                <div
                                                    ...
                                                    {{-- Bearbeiten --}}
                                                    <a href="{{ route('admin.customers.single', $o?->config_name) }}"
                                                        wire:navigate
                                                        style="
                                                            display:inline-flex;
                                                            align-items:center;
                ...
                <div class="modal-content">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card shadow-sm">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{ route('admin.initiate.config') }}" method="POST"
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" data-bs-dismiss="modal"
                            ...
                            <i class="fa fa-times close-icon" style="transition:transform .3s ease;">
                            </i>
