                    ...
                    <div class="col-xl-3 col-sm-5 box-col-4">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="{{ route('admin.roles-perm') }}">Roles/Permissions</a></li>
                        ...
                        <div class="card-body">
                            <div class="form theme-form">
                                ...
                                <div class="p-4">
                                    ...
                                    <div>
                                        <span>Choose a specific Role and choose a Permission to be assigned to this role
                                            Eg. <span style="font-weight: bold;">Role->sub-admin</span> TO <span
                                                style="font-weight: bold;">Permission->can download files</span></span>
                                    </div>
                                </div>
                                ...
                                <div class="row p-4">
                                    ...
                                    <div>
                                        <span>Choose a specific Role and choose a User to be assigned to this role Eg.
                                            <span style="font-weight: bold;">Role->sub-admin</span> TO <span
                                                style="font-weight: bold;">User->clintonace09@gmail.com</span></span>
